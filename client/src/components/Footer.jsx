    ...
    <footer className="bg-neutral-900 dark:bg-neutral-950 text-white transition-colors duration-300">
      <div className="container-main py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="inline-block mb-4">
              <img src={logo} alt="Duta Edukasi" className="h-16 w-auto object-contain" />
            </Link>
            <p className="text-neutral-400 text-sm leading-relaxed max-w-xs">
              Distributor perlengkapan kantor, sekolah, alat pendidikan, fasilitas umum, dan peralatan keselamatan terpercaya untuk instansi dan bisnis di Indonesia.
            </p>
          </div>

          {/* Quick links */}
          <div>
            <h4 className="font-body font-semibold text-white mb-4">Navigasi</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={l.to}>
                  <Link to={l.to} className="text-neutral-400 text-sm hover:text-primary transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+6281234567890" className="hover:text-primary transition-colors">+62 812-3456-7890</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@dutaedukasi.com" className="hover:text-primary transition-colors">info@dutaedukasi.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-neutral-500 text-sm">© 2024 Duta Edukasi. Semua hak dilindungi.</p>
          <a
