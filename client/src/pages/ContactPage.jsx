      ...
      <section className="bg-gradient-to-br from-primary-50 to-white dark:from-neutral-900 dark:to-neutral-950 py-16 transition-colors">
        <div className="container-main text-center">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-lg max-w-xl mx-auto">
            Punya pertanyaan atau ingin meminta penawaran? Tim kami siap membantu Anda.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="font-heading text-2xl text-neutral-900 mb-6">Informasi Kontak</h2>
              <div className="space-y-5">
                {[
                  ...
                  },
                  {
                    ...
                    label: 'Email',
                    value: 'info@dutaedukasi.com',
                    href: 'mailto:info@dutaedukasi.com'
                  }
                ].map((c, i) => (
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {c.href ? (
                        <a href={c.href} className="font-medium text-neutral-800 hover:text-primary transition-colors">{c.value}</a>
                      ) : (
                        <p className="font-medium text-neutral-800">{c.value}</p>
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-8 bg-neutral-100 rounded-2xl h-48 flex items-center justify-center text-neutral-400">
                <div className="text-center">
                  ...
                  <p className="text-xs">Ganti dengan embed iframe dari Google Maps</p>
                </div>
              </div>
            </div>
            ...
            <div className="card p-8">
              <h2 className="font-heading text-2xl text-neutral-900 mb-6">Kirim Pesan</h2>
              {sent ? (
                <div className="text-center py-10">
                  <div className="text-5xl mb-4">✉️</div>
                  <h3 className="font-body font-semibold text-neutral-800 mb-2">Pesan Terkirim!</h3>
                  <p className="text-neutral-500">Terima kasih, kami akan segera menghubungi Anda.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  {[
                    ...
                    <div key={f.key}>
                      <label className="text-sm font-medium text-neutral-700 block mb-1">{f.label}</label>
                      <input
                  ...
                  <div>
                    <label className="text-sm font-medium text-neutral-700 block mb-1">Pesan *</label>
                    <textarea
                      required
                      rows={4}
